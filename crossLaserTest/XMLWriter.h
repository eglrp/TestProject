...
public:
	...
	static void WriteRT33(std::string filename, const vector<Mat>& Outputs);
	...
	//************************************蔡永凯***********************************//
	//保存扫描头设置参数
	static void WriteSettingPara(std::string filename, laserScannerSetting& setParam);

	////保存参数
	//static void WriteSettingPara_pcb
