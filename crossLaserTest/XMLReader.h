...
public:
	...
	static bool ReadRT33(std::string filename, vector<Mat>& Inputs);
	//*************************************zzl add *****************************//
	...
	//************************************蔡永凯***********************************//
	static bool ReadSettingPara(std::string filename, laserScannerSetting& setParam);
...
private:
	...
	//解析测头设置参数
	static bool parseSettingParaElement(TiXmlHandle hDoc, laserScannerSetting& setParam);
